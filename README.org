...
*Warning:* Currently the results of the table of contents is not
correctly cache, so please do a full rebuild of your export, if you
want to have a correct table of contents.
